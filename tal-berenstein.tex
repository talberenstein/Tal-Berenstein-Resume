...
\headedsection
  ...
  \headedsubsection
    {Professional \acr{Front-end Application} Developer}
    {Feb \apo21 -- present}
...
\inlineheadsection
  ...
  {Art, Buddhism, chess, cryptography, functional programming, history, music (from classical and jazz to Berlin-techno), philosophy, poetry,  startups, travel, typography (e.g. \LaTeX), \acr{UX}-design, vegetarian cuisine and  \acr{VRP}.}
